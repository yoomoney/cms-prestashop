...
<h1 class="page-heading">
    {l s='General information' mod='yoomoneymodule'}
</h1>
    ...
    <form action="{$payment_link|escape:'quotes':'UTF-8'}" method="post">
        ...
        <div class="box cheque-box">
            ...
            <p class="cheque-indent">
                <strong class="dark">
                    {l s='You selected payment via bank card.' mod='yoomoneymodule'} {l s='Short description of the order:' mod='yoomoneymodule'}
                </strong>
            </p>
            <p>
